...
! function(a) {
  ...
  a.fn.dropload = function(a) {
    ...
    function l() {
      k.direction = "up", k.$domDown.html(k.opts.domDown.domLoad), k.loading = !0, k.opts.loadDownFn(k)
    }
    var k = this;
    k.opts = a.extend({}, {
      ...
      loadUpFn: "",
      loadDownFn: ""
    }, f), "" != k.opts.loadDownFn && (k.$element.append('<div class="' + k.opts.domDown.domClass + '">' + k.opts.domDown.domRefresh + "</div>"), k.$domDown = a("." + k.opts.domDown.domClass)), k.opts.scrollArea == b ? (k.$scrollArea = d, k._scrollContentHeight = e.height(), k._scrollWindowHeight = c.documentElement.clientHeight) : (k.$scrollArea = k.opts.scrollArea, k._scrollContentHeight = k.$element[0].scrollHeight, k._scrollWindowHeight = k.$element.height()), k._scrollContentHeight <= k._scrollWindowHeight && l(), d.on("resize", function() {
      ...
      k._scrollTop = k.$scrollArea.scrollTop(), k._threshold = "" === k.opts.threshold ? Math.floor(1 * k.$domDown.height() / 3) : k.opts.threshold, "" != k.opts.loadDownFn && !k.loading && !k.isLockDown && k._scrollContentHeight - k._threshold <= k._scrollWindowHeight + k._scrollTop && l()
    })
    ...
    "down" == b.direction && b.upInsertDOM ? b.$domUp.css({
      ...
      b.loading = !1, b.upInsertDOM = !1, a(this).remove(), k(b)
