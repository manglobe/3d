var Calendar = function (id) {
  ...
  this.monthx = this
    .date
    .getMonth() + 1;
  this.month = (this.monthx < 10
    ? "0" + this.monthx
    : this.monthx);
  this.maxyear = this
    .date
    .getFullYear();
  this.maxmonth = (this.monthx < 10
    ? "0" + this.monthx
    : this.monthx);
  this.startyear = -1
  this.startyear = -1;
...
Calendar.prototype.render = function (dataDay) {
  if (this.month < 10) {
  ...
  var _thisDay=dataDay||this.day
 
  btndiv.innerHTML = "<a class='leftbtn'></a><span class='text'>" + this.year + "年" + xdwdd + "月" + _thisDay + "日</span><a  class='rigtbtn'></a>";
  this
    ._skeleton
    .append(btndiv);
  var instance = this;
  ...
  weekdiv.innerHTML = "<span>日</span><span>一</span><span>二</span><span>三</span><span>四</span><span>五</s" +
      "pan><span>六</span>";
  this
    ._skeleton
    .append(weekdiv);
